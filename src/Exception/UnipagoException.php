 ...
 *
 * Define exception padrão do client UniPago
 *
 ...
 */
namespace UnipagoApi\Exception;

/**
 * Class UnipagoException
 * @package UnipagoApi\Exception
 */
class UnipagoException extends \Exception
{
